...
```
DEPLOY_ENV=prod
DEPLOY_HOST=trems-liciob.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
...
prod:
  hosts:
    trems-liciob.tangrama.com.br:
      ansible_user: root
      host: trems-liciob
      hostname: trems-liciob.tangrama.com.br
```
...
Deploy the stack defined in `devops/stacks/trems-liciob.tangrama.com.br.yml` to the remote server with:
